...
public class UnitAssignmentBaseTestCase extends AndroidTestCase {
	...
	public void testCloneByJSON() throws Exception {
		...
		m1.setId(10);
		UnitAssignment m2 = m1.cloneByJSON();
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
		...
		UnitAssignment m3 = m1.cloneByJSON();
		assertEquals(m1, m3);
	}
	...
	public void testSerialize() throws Exception {
		...
		UnitAssignment m1 = new UnitAssignment();
		m1.setId(10);
		UnitAssignment m2 = SerializationUtils.clone(m1);
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
		...
		UnitAssignment m3 = SerializationUtils.clone(m1);
		assertEquals(m1, m3);
	}
	...
	public void testEquals() throws Exception {
		...
		UnitAssignment r = new UnitAssignment();
