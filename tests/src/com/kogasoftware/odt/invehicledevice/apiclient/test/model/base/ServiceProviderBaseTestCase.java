...
public class ServiceProviderBaseTestCase extends AndroidTestCase {
	...
	public void testCloneByJSON() throws Exception {
		...
		m1.setId(10);
		ServiceProvider m2 = m1.cloneByJSON();
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
		...
		ServiceProvider m3 = m1.cloneByJSON();
	...
	public void testEquals() throws Exception {
		...
		ServiceProvider r = l.cloneByJSON();
