...
/**
 * PassengerRecordBaseのテスト
 */
public class PassengerRecordBaseTestCase extends TestCase {
	PassengerRecord model;

	@Override
	public void setUp() throws Exception {
		super.setUp();
		model = new PassengerRecord();
	}
	...
	public void testClone() throws Exception {
		PassengerRecord m1 = new PassengerRecord();
		m1.setId(10);
		PassengerRecord m2 = m1.clone();
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
	...
	public void testSerializable() throws Exception {
		PassengerRecord m1 = new PassengerRecord();
		m1.setId(10);
		PassengerRecord m2 = SerializationUtils.clone(m1);
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
		...
		PassengerRecord m3 = SerializationUtils.clone(m1);
		assertEquals(m1, m3);
	}

	public void testEquals() throws Exception {
		PassengerRecord l = new PassengerRecord();
		PassengerRecord r = l.clone();
	...
	public void testCanSerializable() {
		Model.getObjectMapper().canSerialize(PassengerRecordBase.class);
		Model.getObjectMapper().canSerialize(PassengerRecord.class);
	}

	public void testIdentity() {
		PassengerRecord odd = new PassengerRecord();
		PassengerRecord even = new PassengerRecord();
		LinkedList<PassengerRecord> l1 = Lists.newLinkedList();
		l1.add(even);
		l1.add(odd);
		l1.add(even);
		l1.add(odd);
		
		LinkedList<PassengerRecord> l2 = SerializationUtils.clone(l1);
		assertEquals(l1, l2);
