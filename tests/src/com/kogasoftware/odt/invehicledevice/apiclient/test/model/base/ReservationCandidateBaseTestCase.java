...
/**
 * ReservationCandidateBaseのテスト
 */
public class ReservationCandidateBaseTestCase extends TestCase {
	ReservationCandidate model;

	@Override
	public void setUp() throws Exception {
		super.setUp();
		model = new ReservationCandidate();
	}
	...
	public void testClone() throws Exception {
		ReservationCandidate m1 = new ReservationCandidate();
		m1.setId(10);
		ReservationCandidate m2 = m1.clone();
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
		...
		ReservationCandidate m3 = m1.clone();
	...
	public void testSerializable() throws Exception {
		ReservationCandidate m1 = new ReservationCandidate();
		m1.setId(10);
		ReservationCandidate m2 = SerializationUtils.clone(m1);
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
		...
		ReservationCandidate m3 = SerializationUtils.clone(m1);
		assertEquals(m1, m3);
	}

	public void testEquals() throws Exception {
		ReservationCandidate l = new ReservationCandidate();
		ReservationCandidate r = l.clone();
	...
	public void testCanSerializable() {
		Model.getObjectMapper().canSerialize(ReservationCandidateBase.class);
		Model.getObjectMapper().canSerialize(ReservationCandidate.class);
	}

	public void testIdentity() {
		ReservationCandidate odd = new ReservationCandidate();
		ReservationCandidate even = new ReservationCandidate();
		LinkedList<ReservationCandidate> l1 = Lists.newLinkedList();
		l1.add(even);
		l1.add(odd);
		l1.add(even);
		l1.add(odd);
		
		LinkedList<ReservationCandidate> l2 = SerializationUtils.clone(l1);
		assertEquals(l1, l2);
