 ...
 * ReservationBaseのテスト
 */
public class ReservationBaseTestCase extends TestCase {
	Reservation model;
	...
	public void testClone() throws Exception {
		Reservation m1 = new Reservation();
		m1.setId(10);
		Reservation m2 = m1.clone();
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
	...
	public void testSerializable() throws Exception {
		Reservation m1 = new Reservation();
		m1.setId(10);
		Reservation m2 = SerializationUtils.clone(m1);
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
		...
		Reservation m3 = SerializationUtils.clone(m1);
		assertEquals(m1, m3);
	}

	public void testEquals() throws Exception {
		Reservation l = new Reservation();
		Reservation r = l.clone();
	...
	public void testCanSerializable() {
		Model.getObjectMapper().canSerialize(ReservationBase.class);
		Model.getObjectMapper().canSerialize(Reservation.class);
	}

	public void testIdentity() {
		Reservation odd = new Reservation();
		Reservation even = new Reservation();
		LinkedList<Reservation> l1 = Lists.newLinkedList();
		l1.add(even);
		l1.add(odd);
		l1.add(even);
		l1.add(odd);
		
		LinkedList<Reservation> l2 = SerializationUtils.clone(l1);
		assertEquals(l1, l2);
