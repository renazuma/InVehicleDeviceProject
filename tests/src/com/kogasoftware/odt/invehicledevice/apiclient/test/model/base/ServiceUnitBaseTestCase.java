 ...
 * ServiceUnitBaseのテスト
 */
public class ServiceUnitBaseTestCase extends TestCase {
	ServiceUnit model;
	...
	public void testClone() throws Exception {
		ServiceUnit m1 = new ServiceUnit();
		m1.setId(10);
		ServiceUnit m2 = m1.clone();
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
	...
	public void testSerializable() throws Exception {
		ServiceUnit m1 = new ServiceUnit();
		m1.setId(10);
		ServiceUnit m2 = SerializationUtils.clone(m1);
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
		...
		ServiceUnit m3 = SerializationUtils.clone(m1);
		assertEquals(m1, m3);
	}

	public void testEquals() throws Exception {
		ServiceUnit l = new ServiceUnit();
		ServiceUnit r = l.clone();
	...
	public void testCanSerializable() {
		Model.getObjectMapper().canSerialize(ServiceUnitBase.class);
		Model.getObjectMapper().canSerialize(ServiceUnit.class);
	}

	public void testIdentity() {
		ServiceUnit odd = new ServiceUnit();
		ServiceUnit even = new ServiceUnit();
		LinkedList<ServiceUnit> l1 = Lists.newLinkedList();
		l1.add(even);
		l1.add(odd);
		l1.add(even);
		l1.add(odd);
		
		LinkedList<ServiceUnit> l2 = SerializationUtils.clone(l1);
		assertEquals(l1, l2);
