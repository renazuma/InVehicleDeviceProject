...
public class DriverBaseTestCase extends AndroidTestCase {
	Driver model;
	...
	public void testSerialize() throws Exception {
		...
		Driver m1 = new Driver();
		m1.setId(10);
		Driver m2 = SerializationUtils.clone(m1);
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
		...
		Driver m3 = SerializationUtils.clone(m1);
		assertEquals(m1, m3);
