...
public class VehicleNotificationBaseTestCase extends AndroidTestCase {
	...
	public void testCloneByJSON() throws Exception {
		...
		m1.setId(10);
		VehicleNotification m2 = m1.cloneByJSON();
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
	...
	public void testSerialize() throws Exception {
		...
		VehicleNotification m1 = new VehicleNotification();
		m1.setId(10);
		VehicleNotification m2 = SerializationUtils.clone(m1);
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
