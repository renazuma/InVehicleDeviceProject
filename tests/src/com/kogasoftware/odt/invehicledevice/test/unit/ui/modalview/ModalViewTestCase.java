...
public class ModalViewTestCase extends MockActivityUnitTestCase {
	@Override
	...
	public void testModalView_1() throws Exception {
		Context context = new AccountAuthenticatorActivity();
		AttributeSet attrs = null;

		ModalView result = new ModalView(context, attrs);
