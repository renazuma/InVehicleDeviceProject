...
public class NavigationModalViewTestCase extends EmptyActivityInstrumentationTestCase2 {
	...
	public void testNavigationModalView_1() throws Exception {
		Context context = new AccountAuthenticatorActivity();
		AttributeSet attrs = null;

		NavigationModalView result = new NavigationModalView(context, attrs);
