...
public class StartCheckModalViewTestCase extends EmptyActivityInstrumentationTestCase2 {
	...
	public void testStartCheckModalView_1() throws Exception {
		Context context = new AccountAuthenticatorActivity();
		AttributeSet attrs = null;

		StartCheckModalView result = new StartCheckModalView(context, attrs);
