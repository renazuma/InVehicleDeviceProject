...
public class PauseModalViewTestCase extends EmptyActivityInstrumentationTestCase2 {
	...
	public void testPauseModalView_1() throws Exception {
		Context context = new AccountAuthenticatorActivity();
		AttributeSet attrs = null;

		PauseModalView result = new PauseModalView(context, attrs);
