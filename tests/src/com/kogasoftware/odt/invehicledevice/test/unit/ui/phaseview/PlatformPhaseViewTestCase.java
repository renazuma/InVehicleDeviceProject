...
public class PlatformPhaseViewTestCase extends EmptyActivityInstrumentationTestCase2 {
	@Override
	...
	public void testPlatformPhaseView_1() throws Exception {
		Context context = new AccountAuthenticatorActivity();
		AttributeSet attrs = null;

		PlatformPhaseView result = new PlatformPhaseView(context, attrs);
