...
/**
 * クレジットによる支払い状態の変更を検知した際に、バックエンドへ同期完了の更新を行うためのLoaderクラス
 */

public class CreditPaidChargeChangedNotificationLoader {

    // TODO:InVehicleDeviceActivity配下で一意である必要がある。Activityクラスで管理した方が良い？
    public static final Integer LOADER_ID = 8;

    private final InVehicleDeviceActivity inVehicleDeviceActivity;

    public CreditPaidChargeChangedNotificationLoader(InVehicleDeviceActivity inVehicleDeviceActivity) {
    ...
    private final LoaderManager.LoaderCallbacks<Cursor> callbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        public Loader<Cursor> onCreateLoader(int id, Bundle args) {
            ...
            return new CursorLoader(
                    ...
                    null,
                    VehicleNotification.WHERE_CREDIT_PAID_CHARGE_CHANGED_VEHICLE_NOTIFICATION_FRAGMENT_CONTENT,
                    null, null);
        }
