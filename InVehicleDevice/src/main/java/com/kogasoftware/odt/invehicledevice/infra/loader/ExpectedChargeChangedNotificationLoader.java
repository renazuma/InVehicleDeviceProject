...
/**
 * 予定料金の変更を検知した際に、バックエンドへ同期完了の更新を行うためのLoaderクラス
 */

public class ExpectedChargeChangedNotificationLoader {

    // TODO:InVehicleDeviceActivity配下で一意である必要がある。Activityクラスで管理した方が良い？
    public static final Integer LOADER_ID = 6;

    private final InVehicleDeviceActivity inVehicleDeviceActivity;

    public ExpectedChargeChangedNotificationLoader(InVehicleDeviceActivity inVehicleDeviceActivity) {
