...
public class TopViewLoader {
    ...
    public TopViewLoader(InVehicleDeviceActivity inVehicleDeviceActivity) {
    ...
    private final LoaderManager.LoaderCallbacks<Cursor> topViewCallbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
            ...
            if (cursor.moveToFirst()) {
                ...
                mainUIHandler.post(() -> PhaseFlowLayoutFragment.showModal(inVehicleDeviceActivity));
            } else {
                inVehicleDeviceActivity.setServiceProvider(null);
                mainUIHandler.post(() -> PhaseFlowLayoutFragment.hideModal(inVehicleDeviceActivity));
            }
        }
