	...
	public void uploadOneFile(AmazonS3Client s3Client, String deviceId)
		...
		try {
			...
			try {
				...
				// Source)
				// at
				// com.kogasoftware.odt.invehicledevice.presenter.service.logservice.UploadThread.uploadOneFile(UploadThread.java:75)
				// at
				// com.kogasoftware.odt.invehicledevice.presenter.service.logservice.UploadThread.run(UploadThread.java:106)
