...
public class ReservationCandidateBaseTestCase extends TestCase {
	...
	public void xtestSerializable() throws Exception {
		ReservationCandidate m1 = new ReservationCandidate();
		m1.setId(10);
		ReservationCandidate m2 = Serializations.clone(m1);
		assertFalse(m1 == m2);
		assertEquals(m1, m2);
		...
		ReservationCandidate m3 = Serializations.clone(m1);
		assertEquals(m1, m3);
	}
	...
	public void xtestIdentity() {
		...
		LinkedList<ReservationCandidate> l2 = Serializations.clone(l1);
		assertEquals(l1, l2);
